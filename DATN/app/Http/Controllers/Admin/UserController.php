...
class UserController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $booking = Booking::whereuser_id($id)->where('isdeleted',false)->orderBy('status', 'asc')->orderBy('created_at', 'desc')->get();
        return view('admin.user.detail', compact('user','booking'));
    }

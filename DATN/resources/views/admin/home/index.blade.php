        ...
        <a href="{{route('room.index')}}">
          <div class="card-body">
            <div class="stat-widget-five">
              ...
              <div class="stat-content">
                <div class="text-left dib">
                  <div class="stat-text"><span class="count">{{$room_total}}</span></div>
                  <div class="stat-heading">{{trans('admin.room')}}</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="card">
        <div class="card-body">
          <div class="stat-widget-five">
            ...
            <div class="stat-content">
              <div class="text-left dib">
                <div class="stat-text"><span class="count">{{$votes}}</span></div>
                <div class="stat-heading">{{trans('admin.vote')}}</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-4">
          <div class="card-body">
            ...
            <div class="progress-box progress-2">
              <h4 class="por-title">{{trans('admin.Bookingnumber')}}</h4>
              <div class="progress mb-2" style="height: 5px;">
